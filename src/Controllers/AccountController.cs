...
using FlatPlanetCafe.Models.AccountViewModels;
using FlatPlanetCafe.Services;
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // #1159: Patch up user roles for users created pre-role based policies
                    if (!roleManager.Roles.Any(r => r.Name == "Users"))
